% Main procedure for solving Problem III
...
[w_dagger,theta_dagger,check] = opt_p3(A,C,Q,R,X,K,P,mu_a,VA,delta);
...
disp('AUC value')
auc_p3 = 1-normcdf(abs(opt_mu_r-opt_mu_r1)/sqrt(opt_sig_r^2+opt_sig_r1^2))

save design3.mat opt_aw opt_theta auc_p3
